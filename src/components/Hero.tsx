    ...
    <section id="about" className="pt-32 pb-20 px-4">
      <div className="container mx-auto grid lg:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          <span className="text-amber-500 font-medium">Hello, I'm</span>
          <h1 className="text-4xl md:text-6xl font-bold leading-tight text-gray-800">
            Shodiyona Avazxonova
          </h1>
          <h2 className="text-2xl md:text-3xl text-amber-500 font-medium">
            Lawyer
          </h2>
          ...
          <div className="flex items-center gap-4">
            <Button className="bg-amber-500 hover:bg-amber-600 text-white font-medium px-6 py-6">
              My Projects <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
            <Button variant="outline" className="border-amber-200 text-amber-500 hover:bg-amber-50">
              Resume
            </Button>
          </div>
        </div>
